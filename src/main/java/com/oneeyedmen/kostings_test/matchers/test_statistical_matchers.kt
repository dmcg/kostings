package com.oneeyedmen.kostings_test.matchers
...
data class TestPerformanceData(override val samples: DoubleArray, override val description : String) : PerformanceData {}

open class StatisticalMatchers {
